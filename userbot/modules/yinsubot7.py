...
async def _(hylo)
    ayiin = await edit_or_reply(hylo, "`**Haayolo**`")
    sleep(1)
    await ayiin.edit("`**Haayoloo**`")
    sleep(1)
    await ayiin.edit("`**Haayolooo**`")
    sleep(1)
    await ayiin.edit("`**Haayoloooo**`")
    sleep(3)
    await ayiin.edit("`**Haayolooooo Botnya Mati**` 🤣")
    sleep(2)
    await ayiin.edit("`**Haayolooooo Kenapa Itu Botnya**` 🤣")
    sleep(2)
