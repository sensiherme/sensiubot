...
from userbot import CMD_HELP, COUNT_PM, LASTMSG, LOGS, PM_AUTO_BAN, PM_LIMIT, bot, logo
...
DEF_UNAPPROVED_MSG = (
    ...
    f"⍟ 𝙶𝚄𝙰 𝙰𝙺𝙰𝙽 𝙾𝚃𝙾𝙼𝙰𝚃𝙸𝚂 𝙱𝙻𝙾𝙺𝙸𝚁 𝙺𝙰𝙻𝙾 𝙻𝚄 𝚂𝙿𝙰𝙼 𝚂𝙰𝙼𝙿𝙰𝙸 {COUNT_PM}/{PM_LIMIT} [ㅤ]({logo})\n"
